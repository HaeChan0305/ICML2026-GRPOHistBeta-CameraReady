...
To evaluate how accurately the point estimator $\hat{p}_{\tau}^{\mathrm{pt}}$ and the DBB estimator $\hat{p}_{\tau}^{\mathrm{db}}$ approximate the Bernoulli parameter $p_{\tau}$ during training, we conduct an empirical estimation error analysis.
